...
from ncRNA_utils import getData, coShuffled_vectors, reverse_tensor, compile_and_fit_model_with_tb, getE2eData
...
if __name__ == "__main__":
    ...
    mCNN2_1000.evaluate(X_val_1000e, Y_val_1000e)  # 97.20% (the real validation data)
    ...
    mRNN_1000l.evaluate(X_val_1000e, Y_val_1000e)  # 96.15% (the real validation data)
